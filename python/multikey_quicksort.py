...
class MultikeyQuicksort(SuffixSorter):
    ...
    def multikeyQuicksort(self, start: int, end: int, offset: int):
        ...
        pivotstart,pivotend = self.partition(start,end,offset)
        self.multikeyQuicksort(start, pivotstart, offset)
        self.multikeyQuicksort(pivotstart, pivotend, offset+1)
        self.multikeyQuicksort(pivotend, end, offset)
        #---------- END TASK 5 -----------------------------------------------#
